...
== Usage
    ...
    => 4:30
    >> ChronicDuration.output(5306520, :format => :long, :units => [:days, :hours, :minutes])
    => 61 days 10 hours 2 minutes
    >> ChronicDuration.output(5306400, :format => :long, :units => [:days, :hours, :minutes], :keep_zero => true)
    => 61 days 10 hours 0 minutes
